...
[![npm](https://img.shields.io/npm/v/peasy-audio-embed)](https://www.npmjs.com/package/peasy-audio-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/peasy-audio-embed)
[![Size](https://img.shields.io/badge/gzipped-<8KB-green)](https://bundlephobia.com/package/peasy-audio-embed)

Embed **PeasyAudio** widgets on any website or blog. Audio conversion, compression, trimming, and format tools. Each widget is completely isolated via **Shadow DOM**, requires **zero dependencies**, and supports **3 built-in themes** (light, dark, sepia). The self-executing script finds all `data-peasy-audio` elements on the page and renders interactive widgets automatically, including support for dynamically added elements in single-page applications via MutationObserver.

PeasyAudio is part of the [Peasy Tools](https://peasytools.com) ecosystem, providing 11 widget types for embedding file format information, tool cards, conversion guides, glossary terms, search boxes, and interactive tools directly into your pages.

> **Try the interactive widget builder at [widget.peasyaudio.com](https://widget.peasyaudio.com)** -- build, preview, and copy embed code for any widget type.

<p align="center">
  <img src="demo.gif" alt="peasy-audio-embed demo -- embed peasyaudio widgets with Shadow DOM isolation and theme support" width="800">
</p>
...
That's it. The script will find all `data-peasy-audio` elements, fetch data from the PeasyAudio API, and render each widget with full Shadow DOM style isolation.

## Widget Types

PeasyAudio supports 11 widget types -- 11 common types available on all Peasy sites.

| Type | Description | Usage |
|------|-------------|-------|
| `format` | File format info card with specs, MIME type, and use cases | `<div data-peasy-audio="format" data-slug="..."></div>` |
| `tool` | Tool card with description and direct launch link | `<div data-peasy-audio="tool" data-slug="..."></div>` |
| `convert` | Conversion card showing input/output format pair | `<div data-peasy-audio="convert" data-slug="..."></div>` |
| `compare` | Side-by-side comparison of two formats or tools | `<div data-peasy-audio="compare" data-slug="..."></div>` |
| `glossary` | Glossary term tooltip with definition on hover | `<div data-peasy-audio="glossary" data-slug="..."></div>` |
| `gallery` | Grid gallery of available tools for a category | `<div data-peasy-audio="gallery" data-slug="..."></div>` |
| `guide` | Guide/tutorial card with summary and read-more link | `<div data-peasy-audio="guide" data-slug="..."></div>` |
| `usecase` | Use-case card showing when and why to use a tool | `<div data-peasy-audio="usecase" data-slug="..."></div>` |
| `badge` | Inline badge showing format type or tool category | `<div data-peasy-audio="badge" data-slug="..."></div>` |
| `search` | Search box with autocomplete for tools and formats | `<div data-peasy-audio="search" data-slug="..."></div>` |
| `interactive` | Embedded interactive tool via iframe | `<div data-peasy-audio="interactive" data-slug="..."></div>` |
...
|-----------|--------|---------|-------------|
| `data-peasy-audio` | format, tool, convert, compare, glossary, gallery, guide, usecase, badge, search, interactive | *required* | Widget type to render |
...
<div data-peasy-audio="format" data-slug="mp3" data-theme="light"></div>

<!-- Dark theme -- dark background, light text -->
<div data-peasy-audio="format" data-slug="mp3" data-theme="dark"></div>

<!-- Sepia theme -- warm, paper-like appearance -->
<div data-peasy-audio="format" data-slug="mp3" data-theme="sepia"></div>

<!-- Auto theme -- follows prefers-color-scheme -->
<div data-peasy-audio="format" data-slug="mp3" data-theme="auto"></div>
```

Each theme sets CSS custom properties inside the Shadow DOM. The accent color (`#F59E0B`) is consistent across all themes, providing brand recognition for PeasyAudio.
...
```html
<script type="module">
  import 'https://cdn.jsdelivr.net/npm/peasy-audio-embed@1/dist/embed.esm.js';
</script>
```
...
```html
<!-- PeasyAudio format info card with light theme -->
<div data-peasy-audio="format" data-slug="mp3" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-audio-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- PeasyAudio tool card -->
<div data-peasy-audio="tool" data-slug="mp3" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-audio-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Search across PeasyAudio tools and formats -->
<div data-peasy-audio="search"
  data-placeholder="Search PeasyAudio tools..."
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-audio-embed@1/dist/embed.min.js"></script>
```
...
```html
<p>This file is in <div data-peasy-audio="badge" data-slug="mp3"></div> format.</p>
<script src="https://cdn.jsdelivr.net/npm/peasy-audio-embed@1/dist/embed.min.js"></script>
```
...
```html
<div data-peasy-audio="glossary" data-slug="lossless" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-audio-embed@1/dist/embed.min.js"></script>
```
...
- **CORS**: PeasyAudio API has CORS enabled for all origins
...
- **Powered by**: Each widget includes a subtle "PeasyAudio" backlink in the footer

## Learn More

Visit [peasyaudio.com](https://peasyaudio.com) for the full PeasyAudio experience.

- **All Tools**: [peasyaudio.com](https://peasyaudio.com)
- **Formats**: [peasyaudio.com/formats/](https://peasyaudio.com/formats/)
- **Glossary**: [peasyaudio.com/glossary/](https://peasyaudio.com/glossary/)
- **Guides**: [peasyaudio.com/guides/](https://peasyaudio.com/guides/)
- **API Documentation**: [peasyaudio.com/developers/](https://peasyaudio.com/developers/)
- **OpenAPI Spec**: [peasyaudio.com/api/openapi.json](https://peasyaudio.com/api/openapi.json)
- **Widget Builder**: [widget.peasyaudio.com](https://widget.peasyaudio.com)
- **npm Package**: [npmjs.com/package/peasy-audio-embed](https://www.npmjs.com/package/peasy-audio-embed)
